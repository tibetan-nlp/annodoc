...
Util.profileStart('before render');
      ...
      var setLayoutDensity = function(_density) {
        ...
        if (_density < 2) {
          ...
          Configuration.visual.curlyHeight = 3;
          Configuration.visual.arcSpacing = 8;
          Configuration.visual.arcStartHeight = 41;
        } else if(_density > 2) {
          // spacious
          Configuration.visual.margin = { x: 2, y: 1 };
          Configuration.visual.boxSpacing = 3;
          Configuration.visual.curlyHeight = 6;
          Configuration.visual.arcSpacing = 20;
          ...
          Configuration.visual.arcSpacing = 14;
          Configuration.visual.arcStartHeight = 40;
        }
        dispatcher.post('configurationChanged');
      }
