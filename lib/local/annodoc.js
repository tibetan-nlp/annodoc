...
//         		      function(a, b) { return b.replace(/\s+/g, ' '); });
    ...
    var displaySpanInformation = function(evt, target, spanId, spanType,
        ...
        //b = escape(this.encodeUtf8(b));
        var tttUrl = "http://ttt.thlib.org/org.thdl.tib.scanner.RemoteScannerFilter?jwf=ttt&text=la";
        var scriptEl = document.createElement('script');
        scriptEl.setAttribute('src', tttUrl);
        document.body.appendChild(scriptEl);

        /* var tttUrl = "http://ttt.thlib.org/org.thdl.tib.scanner.RemoteScannerFilter?jwf=?&text=la";
